...
const countNumberOfElements = (arr) => {
    let countNumberOfElements = arr.reduce((answeresSoFar, value, inx) =>{
     countNumberOfElements.push(value);
     return answeresSoFar;
  }, []);
  }
/* ------------------------------------------------------------------------------------------------
CHALLENGE 2
...
const returnNames = (arr) => {
  let returnNames = arr.reduce((answeresSoFar, names) =>{
    returnNames.push(names);
    return answeresSoFar;
 }, 
...
const reversedString = (str) => {
  let reversedString = str.reduce((answeresSoFar, letters, index))
    if(reversedString > answeresSoFar)
    return answeresSoFar
};
