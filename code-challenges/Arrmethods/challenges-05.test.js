...
const listFoods = (recipe) => {
  ...
  for(let i=0 ; i < recipe.ingredients.length ; i++){
   ...
   index = str2.indexOf(' ')
   str2.slice(index)
   result.push(str2.slice(index + 1))
  }
...
const splitFoods = (recipe) => {
  ...
  for(let i=0 ; i < recipe.ingredients.length ; i++){
   let str = recipe.ingredients[i]
   let index = str.indexOf(' ')
   let str2 = str.split(index)
   index = str2.indexOf(' ')
   str2.split(index)
   result.push(str2.split(index))
  }
...
------------------------------------------------------------------------------------------------ */
const stepAction = (recipe) => {
  let result = [];

  for(let i=0 ; i < recipe.steps.length ; i++){
   let str = recipe.steps[i]
   let index = str.indexOf(' ')
   let str2 = str.slice(0, index + 1)
   result.push(str2.slice(0,index + 1))
  }
...
const removeEvenValues = (arr) => {
  let removeEvenValues = [];
  for(let i=0 ; i < arr.lenth ; i++){
    removeEvenValues.splice(i + 1 , 1);
  }
