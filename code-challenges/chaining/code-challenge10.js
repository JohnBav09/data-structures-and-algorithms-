...
divisibleByFiveTwoToThePower.sum(); Math.pow(divisibleByFiveTwoToThePower, 2)
...
let findMaleAndFemale = (data) => {
 findMaleAndFemale.filter(gender.male, gender.female).map()
};
...
let findShortest = (data) => {
    findShortest = []
if (starWarsData.height < 50)
  findShortest.push(data)
};
